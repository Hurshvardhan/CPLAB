# -*- coding: utf-8 -*-
"""
Created on Tue Jul 12 18:55:30 2016
...
class ExperimentalRunNewModel(ExperimentalRunFit):
    ...
    def plot_error(self):
        ...
        K1.append(self.k[0])
        K2.append(self.k[1])
        K1err.append(self.kerr[0])
        K2err.append(self.kerr[1])
...
exp400.fit()
exp400.plot_error()
print 'K1 @ 250 300 350 400 K are respectively as follows:'
print K1

print 'K2 @ 250 300 350 400 K are respectively as follows:'
print K2

"""FINDING ARRHENIUS CONSTANT AND ENERGY OF ACTIVATION"""
...
print 'Arrhenius constant and energy of activation respectively are'
P=res[0]
print P
print 'covariance is'
pcov=res[1]
...
plt.ylabel('rate constant k1')
fig.canvas.draw()
plt.show()

"""FOR 2ND REACTION"""
pguess=[0.04,400]
res=scipy.optimize.curve_fit(curve,x,K2,[0.04,400],K2err)
print 'Arrhenius constant and energy of activation respectively are'
P=res[0]
print P
print 'covariance is'
