...
df = pd.read_csv("C:\Users\Yash Patil\Desktop\Sim Lab\ExamProblemData.csv",  #The name of the csv file
...
print "This show a very good fit with a large error, so the fit is quite meaningless"
"""
This did not work
def k(A,Ea):
